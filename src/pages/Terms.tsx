...
const Terms = () => {
  return (
    <>
      <section>
        <h2 className="text-[32px] font-bold mb-[30px]">利用規約</h2>
        <p>
          この利用規約（以下、「本規約」といいます。）は、「MyNewGear」（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>
        <p className="text-[24px] font-bold mt-[30px] mb-[15px]">
          第1条（適用）
        </p>
        <ol className="ml-[38px] list-decimal space-y-[10px] md:ml-[21px]">
          <li>
        ...
        <ol className="ml-[38px] list-decimal space-y-[10px] md:ml-[21px]">
          ...
          <li>
            ...
            <ol className="ml-[38px] mt-[15px] list-decimal space-y-[10px] md:ml-[21px]">
        ...
        <ol className="ml-[38px] list-decimal space-y-[10px] mt-[10px] md:ml-[21px]">
          ...
          <li>
            ...
            <ol className="ml-[38px] mt-[15px] mb-[15px] list-decimal space-y-[10px] md:ml-[21px]">
              <li>過度に暴力的な表現</li>
              <li>露骨な性的表現</li>
              <li>
        ...
        <p className="text-right mt-[30px]">以上</p>
      </section>
    </>
  );
};
