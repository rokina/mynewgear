  ...
  return (
    <>
      <section>
        ...
        <p>
          この利用規約（以下，「本規約」といいます。）は，「MyNewGear
          Inc」（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
        </p>
        <p className="text-[24px] font-bold mt-[30px] mb-[15px]">
          第1条（適用）
        </p>
        <ol className="ml-[50px] list-decimal space-y-[10px]">
          <li>
        ...
        <ol className="ml-[50px] list-decimal space-y-[10px]">
          ...
          <li>
            ...
            <ol className="ml-[50px] mt-[15px] list-decimal space-y-[10px]">
        ...
        <ol className="ml-[50px] list-decimal space-y-[10px] mt-[10px]">
          ...
          <li>
            ...
            <ol className="ml-[50px] mt-[15px] mb-[15px] list-decimal space-y-[10px]">
              <li>過度に暴力的な表現</li>
              <li>露骨な性的表現</li>
              <li>
